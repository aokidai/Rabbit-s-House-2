...
namespace Rabbit_s_House.masterDataSetTableAdapters {
...
SELECT MaMon, TenMon, Gia, loai FROM Mon WHERE (MaMon = @MaMon)";
        ...
        public virtual int Fill(masterDataSet.MonDataTable dataTable) {
        ...
        public virtual masterDataSet.MonDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            masterDataSet.MonDataTable dataTable = new masterDataSet.MonDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(masterDataSet.MonDataTable dataTable) {
