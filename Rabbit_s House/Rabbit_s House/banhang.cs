...
namespace Rabbit_s_House
{
    public partial class banhang : Form
    {
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (!Functions.CheckKey(sql))
            {
                ...
                sql = "INSERT INTO tblHDBan(MaHDBan, NgayBan, MaNhanVien, MaKhach, TongTien) VALUES (N'" + txtMaHDBan.Text.Trim() + "','" +
                        Functions.ConvertDateTime(dateTimePicker1.Text.Trim()) + "',N'" + cboMaNhanVien.SelectedValue + "',N'" +
        ...
        {
            Functions.FillCombo("SELECT MaHDBan FROM tblHDBan", cboMaHang, "MaHDBan", "MaHDBan");
            cboMaHang.SelectedIndex = -1;
        }
